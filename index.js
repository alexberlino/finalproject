...
app.get("/de/seonews", function(request, response) {
  response.writeHead(302, {
    Location: "https://www.seoberlino.com/de",
    Expires: new Date().toGMTString()
  });
...
app.get("/fr/onpage", function(request, response) {
  response.writeHead(302, {
    Location: "https://www.seoberlino.com/fr",
    Expires: new Date().toGMTString()
  });
  response.end();
});
...
app.get("/fr/resources", function(request, response) {
  response.writeHead(302, {
    Location: "https://www.seoberlino.com/fr",
    Expires: new Date().toGMTString()
  });
...
app.get("/fr/article/linkbuilding-getting-right-in-20018", function(
  request,
  response
) {
  response.writeHead(301, {
