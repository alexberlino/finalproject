...
var englishHP = function(req, res) {
    ...
    res.render("home", {
        ...
        description:
            "SEO Company for SEO Consultancy, with over 10 years experience €100m + multinationals:  Montblanc, HelloFresh, Spreadshirt, Spartoo, Ricoh, BSH, MSF, Red Cross, etc",
...
app.get("/en/seo-consultant", (req, res) => {
    ...
    res.render("beratung", {
        ...
        layout: "main",
        description:
            "SEO Freelance Consultant in Berlin, experienced in international SEO. Audits by Expert SEO Consultant with 10 years experience. Clients: Montblanc, Spreadshirt, Ricoh, HelloFresh, etc.",
...
app.get("/de/google-ranking-verbessern", (req, res) => {
    ...
    res.render("googleranking", {
        ...
        layout: "mainDE",
        title:
            "Google Ranking verbessern  • SEO Beratung & Consulting | seoberlino",
        description:
...
app.get("/en/google-ranking", (req, res) => {
    ...
    res.render("googleranking", {
        ...
        title:
            "How to improve your Google Rankings • SEO Consultancy in Germany | seoberlino",
        layout: "main",
        description:
            "SEO Freelance Consultant in Berlin, experienced in international SEO. Audits by Expert SEO Consultant with 10 years experience. Clients: Montblanc, Spreadshirt, Ricoh, HelloFresh, etc.",
...
app.get("/en/seo-tools", (req, res) => {
    ...
    res.render("seotools", {
        requrl: "https://www.seoberlino.com/en" + req.originalUrl.substring(3),
        title:
            "SEO Tools for an SEO Check • SEO Consultancy in Germany | seoberlino",
        layout: "main",
        description:
            "SEO Freelance Consultant in Berlin, experienced in international SEO. Audits by Expert SEO Consultant with 10 years experience. Clients: Montblanc, Spreadshirt, Ricoh, HelloFresh, etc.",
...
app.get("/de/seo-tools", (req, res) => {
    ...
    res.render("seotools", {
        requrl: "https://www.seoberlino.com/en" + req.originalUrl.substring(3),
        title:
            "SEO Tools für SEO Check • SEO Consultancy in Germany | seoberlino",
        layout: "mainDE",
        description:
            "SEO Freelance Consultant in Berlin, experienced in international SEO. Audits by Expert SEO Consultant with 10 years experience. Clients: Montblanc, Spreadshirt, Ricoh, HelloFresh, etc.",
...
app.get("/en/jobs", (req, res) => {
    ...
    res.render("jobs", {
        ...
        description:
            "SEO Jobs in Berlin for a SEO Consultancy Company with over 10 years experience €100m + multinationals:  Montblanc, HelloFresh, Spreadshirt, Spartoo, Ricoh, BSH, MSF, Red Cross, etc",
...
app.get("/en/references", (req, res) => {
    ...
    res.render("references", {
        ...
        description:
            "SEO Consulant in Berlin • SEO Consultancy Company with over 10 years experience €100m + multinationals:  Montblanc, HelloFresh, Spreadshirt, Spartoo, Ricoh, BSH, MSF, Red Cross, etc",
...
app.get("/en/seo-services", (req, res) => {
    ...
    res.render("blog", {
        ...
        description:
            "Website optimization, about SEO and its most important challenges. SEO Consultant in Berlin. Close to 10 years experience in SEO, Analytics and SEA.",
...
app.get("/de/seo-optimierung/metas", (req, res) => {
    ...
    res.render("blogonpage/blogmeta", {
        ...
        layout: "mainDE",
        title:
            "Metas Tags, Meta Beschreibung & Titles für SEO | SEO Optimierung | SEO Berlino",
        description:
            "Website optimization, about SEO and its most important challenges. SEO Consultant in Berlin. Close to 10 years experience in SEO, Analytics and SEA.",
...
app.get("/de/seo-optimierung/crawl", (req, res) => {
    ...
    res.render("blogtech/blogcrawl", {
        ...
        description:
            "Website optimieren, about SEO and its most important challenges. SEO Consultant in Berlin. Close to 10 years experience in SEO, Analytics and SEA.",
...
app.get("/de/seo-optimierung/international", (req, res) => {
    ...
    res.render("blogtech/bloginternational", {
        ...
        layout: "mainDE",
        title:
            "hreflang und SEO Internationalisierung | SEO Optimierung | SEO Berlino",
        description:
            "Website optimieren: hreflang und SEO Internationalisierung. ",
        canonical:
            "https://www.seoberlino.com/de/seo-optimierung/international",
...
app.get("/en/seo-services/mobile", (req, res) => {
    ...
    res.render("blogtech/blogmobile", {
        ...
        layout: "main",
        title:
            "Importance of a Mobile Friendly Website  | Website optimization",
        description:
            "Website optimization, about SEO and its most important challenges. SEO Consultant in Berlin. Close to 10 years experience in SEO, Analytics and SEA.",
...
app.get("/de/seo-optimierung/mobile", (req, res) => {
    ...
    res.render("blogtech/blogmobile", {
        ...
        description:
            "Website optimieren, SEO and its most important challenges. SEO Consultant in Berlin. Close to 10 years experience in SEO, Analytics and SEA.",
...
app.get("/de/seo-optimierung/backlinks", (req, res) => {
    ...
    res.render("blogoffpage/blogbacklinks", {
        ...
        description:
            "Website optimization, über SEO. SEO Berater in Berlin. 10 Jahre Erfahrung: SEO, Analytics und SEA.",
...
app.get("/de/seo-optimierung/keyword-research", (req, res) => {
    ...
    res.render("blogonpage/blogKW", {
        ...
        layout: "mainDE",
        title: "Keyword Recherche | Keywords finden | SEO Berlino",
        description:
            "Website optimization, über SEO. SEO Berater in Berlin. 10 Jahre Erfahrung: SEO, Analytics und SEA.",
        canonical:
            "https://www.seoberlino.com/de/seo-optimierung/keyword-research",
...
app.get("/en/seo-services/keyword-research", (req, res) => {
    ...
    res.render("blogonpage/blogKW", {
        ...
        description:
            "Website optimization, über SEO. SEO Berater in Berlin. 10 Jahre Erfahrung: SEO, Analytics und SEA.",
        canonical:
            "https://www.seoberlino.com/en/seo-services/keyword-research",
...
app.get("/de/seo-optimierung/technical-seo", (req, res) => {
    ...
    res.render("blogtech/blogtechnical", {
        ...
        description:
            "Website optimization, about SEO and its most important challenges. SEO Consultant in Berlin. Close to 10 years experience in SEO, Analytics and SEA.",
        canonical:
            "https://www.seoberlino.com/de/seo-optimierung/technical-seo",
...
app.get("/de/seo-optimierung", (req, res) => {
    ...
    res.render("blog", {
        ...
        description:
            "Optimierung für Suchmaschinen, SEO Optimierung, SEO Experte in Berlin. SEO und Webanalyse Blog.",
...
app.get("/en/seo-services/case-study-fromatob", (req, res) => {
    ...
    res.render("blogcase/casestudyfromatob", {
        ...
        description:
            "Mini SEO Case Study about Berlin's fromAtoB: Main keywords, Backlinks, Trend, Brand and other main SEO factors.",
        canonical: "https://www.seoberlino.com" + req.originalUrl,
...
app.get("/en/seo-services/case-study-zalando", (req, res) => {
    ...
    res.render("blogcase/casestudyzalando", {
        ...
        description:
            "Mini SEO Case Study about Berlin's Zalando: Main keywords, Backlinks, Trend, Brand and other main SEO factors.",
        canonical: "https://www.seoberlino.com" + req.originalUrl,
        alt: "https://www.seoberlino.com" + req.originalUrl
    });
});
...
app.get("/en/seo-services/case-study-wooga", (req, res) => {
    ...
    res.render("blogcase/casestudywooga", {
        ...
        description:
            "Mini SEO Case Study about Berlin's Wooga: Main keywords, Backlinks, Trend, Brand and other main SEO factors.",
        canonical: "https://www.seoberlino.com" + req.originalUrl,
        alt: "https://www.seoberlino.com" + req.originalUrl
    });
});
...
app.get("/en/seo-services/case-study-juniqe", (req, res) => {
    ...
    res.render("blogcase/casestudyjuniqe", {
        ...
        description:
            "Mini SEO Case Study about Berlin's Juniqe: Main keywords, Backlinks, Trend, Brand and other main SEO factors.",
        canonical: "https://www.seoberlino.com" + req.originalUrl,
        alt: "https://www.seoberlino.com" + req.originalUrl
    });
});
...
app.get("/en/seo-services/case-study-modomoto", (req, res) => {
    ...
    res.render("blogcase/casestudymodomoto", {
        ...
        description:
            "Mini SEO Case Study about Berlin's Modomoto: Main keywords, Backlinks, Trend, Brand and other main SEO factors.",
        canonical: "https://www.seoberlino.com" + req.originalUrl,
        alt: "https://www.seoberlino.com" + req.originalUrl
    });
});
...
app.get("/en/seo-services/case-study-n26", (req, res) => {
    ...
    res.render("blogcase/casestudyn26", {
        ...
        description:
            "Mini SEO Case Study about Berlin's N26: Main keywords, Backlinks, Trend, Brand and other main SEO factors.",
        canonical: "https://www.seoberlino.com" + req.originalUrl,
        alt: "https://www.seoberlino.com" + req.originalUrl
    });
});
...
app.get("/en/seo-services/case-study-hellofresh", (req, res) => {
    ...
    res.render("blogcase/casestudyhellofresh", {
        ...
        description:
            "Mini SEO Berlin Case Study about Berlin's HelloFresh: Main keywords, Backlinks, Trend, Brand and other main SEO factors.",
        canonical: "https://www.seoberlino.com" + req.originalUrl,
        alt: "https://www.seoberlino.com" + req.originalUrl
    });
});
...
app.get("/en/seo-services/case-study-hometogo", (req, res) => {
    ...
    res.render("blogcase/casestudyhometogo", {
        ...
        description:
            "Mini SEO Case Study about Berlin's HomeToGo: Main keywords, Backlinks, Trend, Brand and other main SEO factors.",
        canonical: "https://www.seoberlino.com" + req.originalUrl,
        alt: "https://www.seoberlino.com" + req.originalUrl
    });
});
...
app.get("/en/seo-services/competitor-analysis", (req, res) => {
    ...
    res.render("blogcase/competitor", {
        ...
        description:
            "SEO Competitor Analysis is important to gather information from the industry leaders: keywords, site structure, backlinks, etc.",
        canonical: "https://www.seoberlino.com" + req.originalUrl,
...
app.get("/en/seo-services/backlink-analysis", (req, res) => {
    ...
    res.render("blogoffpage/blogbacklinkanalysis", {
        ...
        description:
            "Backlinks and Offpage SEO represent a key part of SEO and include in particular Link Building and Brand Building.",
        canonical: "https://www.seoberlino.com" + req.originalUrl,
...
app.get("/de/seo-optimierung/backlink-analysis", (req, res) => {
    ...
    res.render("blogoffpage/blogbacklinkanalysis", {
        ...
        description:
            "Backlinks sind ein wichtiger Bestandteil von SEO und umfassen insbesondere Link Building und Brand Building.",
        canonical: "https://www.seoberlino.com" + req.originalUrl,
...
app.get("/en/impressum", (req, res) => {
    ...
    res.render("impressum", {
        ...
        description:
            "SEOBerlino Impressum. SEO Consultant in Berlin. Close to 10 years experience in SEO, Analytics and SEA.",
...
app.get("/de/impressum", (req, res) => {
    ...
    res.render("impressum", {
        ...
        title: "Impressum | seoberlino",
        description:
            "SEO Spezialist in Berlin. Impressum für SEO Berater, Experte in Webanalyse, SEA und SEO.",
        canonical: "https://www.seoberlino.com/de/impressum",
...
app.get("/de/datenschutz", (req, res) => {
    ...
    res.render("datenschutz", {
        ...
        description:
            "seoberlino Datenschuzt. Audits können im Umfang je nach Bedarf und Reife der Webseite variieren .",
...
app.get("/en/sea", (req, res) => {
    ...
    res.render("beratungsea", {
        ...
        description:
            "SEA Expert for SEA Projects: Google Ads, Facebook Ads, Instagram. Set-up, Testing, Analytics and Optimization.",
        canonical: "https://www.seoberlino.com" + req.originalUrl,
...
app.get("/en/agile-coach-berlin", (req, res) => {
    ...
    res.render("beratungscrum", {
        ...
        description:
            "Experienced Agile Coach for Agile implementation. Agile experience at HelloFresh and Spreadshirt. Scrum Certified Scrum Master and experienced as both Scrum Master and Product owner.",
        canonical: "https://www.seoberlino.com" + req.originalUrl
    });
});
...
app.get("/de/agile-coach-berlin", (req, res) => {
    ...
    res.render("beratungscrum", {
        ...
        title: "Agile Coach / Scrum Master in Berlin | seoberlino",
        description:
            "Implementieren Sie Scrum für Ihre Projekte. 10 Jahre erfahrener Scrum-Master und Product Owner.",
...
app.get("/en/seo-services/googleanalytics", (req, res) => {
    ...
    res.render("blogtech/googleanalytics", {
        requrl: "https://www.seoberlino.com/en" + req.originalUrl.substring(3),
        layout: "main",
        title: "Google Analytics  | seoberlino",
        description:
            "SEO Glossary for SEO. Learn about SEO Jargon and what some terms mean: Canonicals, hreflangs, noindex, nofollow, etc. ",
        canonical: "https://www.seoberlino.com" + req.originalUrl,
...
app.get("/de/seo-optimierung/googleanalytics", (req, res) => {
    ...
    res.render("blogtech/googleanalytics", {
        ...
        layout: "mainDE",
        title: "Google Analytics einrichten | seoberlino",
        description:
            "Canonical und andere Suchmaschinenoptimierung Begriffe. SEO Glossar: canonicals, noindex, nofollow, search console, Google Keyword Finder, etc.",
        canonical: "https://www.seoberlino.com" + req.originalUrl,
...
app.get("/en/seo-services/googlesearchconsole", (req, res) => {
    ...
    res.render("blogtech/googlesearchconsole", {
        requrl: "https://www.seoberlino.com/en" + req.originalUrl.substring(3),
        layout: "main",
        title: "Search Console | seoberlino",
        description:
            "SEO Glossary for SEO. Learn about SEO Jargon and what some terms mean: Canonicals, hreflangs, noindex, nofollow, etc. ",
        canonical: "https://www.seoberlino.com" + req.originalUrl,
...
app.get("/de/seo-optimierung/googlesearchconsole", (req, res) => {
    ...
    res.render("blogtech/googlesearchconsole", {
        requrl:
            "https://www.seoberlino.com/en/seo-services/googlesearchconsole",
        layout: "mainDE",
        title: "Search Console einrichten | seoberlino",
        description:
            "Canonical und andere Suchmaschinenoptimierung Begriffe. SEO Glossar: canonicals, noindex, nofollow, search console, Google Keyword Finder, etc.",
        canonical: "https://www.seoberlino.com" + req.originalUrl,
...
app.get("/en/seo-services/seospecialist", (req, res) => {
    ...
    res.render("blogtech/seospecialist", {
        requrl: "https://www.seoberlino.com/en" + req.originalUrl.substring(3),
        layout: "main",
        title: "SEO Specialist | seoberlino",
        description:
            "SEO Glossary for SEO. Learn about SEO Jargon and what some terms mean: Canonicals, hreflangs, noindex, nofollow, etc. ",
        canonical: "https://www.seoberlino.com" + req.originalUrl,
...
app.get("/de/seo-optimierung/seospecialist", (req, res) => {
    ...
    res.render("blogtech/seospecialist", {
        ...
        layout: "mainDE",
        title: "SEO Spezialist| seoberlino",
        description:
            "Canonical und andere Suchmaschinenoptimierung Begriffe. SEO Glossar: canonicals, noindex, nofollow, search console, Google Keyword Finder, etc.",
        canonical: "https://www.seoberlino.com" + req.originalUrl,
...
app.get("/en/seo-services/searchengines", (req, res) => {
    ...
    res.render("blogtech/suchmaschinen", {
        requrl: "https://www.seoberlino.com/en" + req.originalUrl.substring(3),
        layout: "main",
        title: "Search Engines | seoberlino",
        description:
            "Search Enginles, Noindex, Redirects, Accelerated Mobile Pages: SEO Glossary for SEO. Learn about SEO Jargon and what some terms mean: Canonicals, hreflangs, noindex, nofollow, etc. ",
        canonical: "https://www.seoberlino.com" + req.originalUrl,
...
app.get("/de/seo-optimierung/searchengines", (req, res) => {
    ...
    res.render("blogtech/suchmaschinen", {
        requrl: "https://www.seoberlino.com/en/seo-services/amp",
        layout: "mainDE",
        title: "Suchmaschinen | seoberlino",
        description:
            "Suchmaschinen, Noindex, Redirects, Canonical und andere Suchmaschinenoptimierung Begriffe. SEO Glossar: canonicals, noindex, nofollow, search console, Google Keyword Finder, etc.",
        canonical: "https://www.seoberlino.com" + req.originalUrl,
...
app.get("/en/seo-services/linkbuilding-in-2020", (req, res) => {
    ...
    res.render("blogoffpage/bloglinksgettingitright", {
        ...
        description:
            "Link Building in one of the most difficult but important aspects of SEO. Read these tips to start your Backlinking tasks.",
        canonical: "https://www.seoberlino.com" + req.originalUrl
    });
});
...
app.get("/en/seo-services/voicesearch", (req, res) => {
    ...
    res.render("blogonpage/blogvoice", {
        ...
        description:
            "Once you are ready for mobile first, the next step is to prepare your website for Voice Search. Everything you need to know about Voice Search.",
        canonical: "https://www.seoberlino.com" + req.originalUrl
    });
});
...
app.get("/en/seo-services/clutch", (req, res) => {
    ...
    res.render("blogcase/blogclutch", {
        ...
        description:
            "Clutch has selected seoberlino as one of the top SEO companies in Germany for 2019. Read the Press Release from Clutch.",
        canonical: "https://www.seoberlino.com" + req.originalUrl
    });
});
...
app.get("/en/seo-services/seo-in-asia-korea-china-japan-2020", (req, res) => {
    ...
    res.render("blogcase/blogasia", {
        ...
        description:
            "Blog article about SEO in Asia and Search Engines in Asia. How to approach SEO for the Asian market.",
        canonical: "https://www.seoberlino.com" + req.originalUrl
    });
});
...
app.get("/en/seo-services/beyond-mobile-first", (req, res) => {
    ...
    res.render("blogtech/blogmobile-first", {
        ...
        description:
            "More people now surf the net on mobile than on Desktop and Google now uses mobile indexation as the norm ahead of Desktop.",
        canonical:
            "https://www.seoberlino.com/en/seo-services/beyond-mobile-first"
    });
});
...
app.get(
    ...
    (req, res) => {
        ...
        res.render("blogtech/blogstructureddata", {
            requrl:
                "https://www.seoberlino.com/en" + req.originalUrl.substring(3),
            layout: "mainNoAlt",
            title: "Structured Data SEO | seoberlino",
            description:
                "SEO Blog article about Structured Data and why you need to implement them to improve your SEO.  Everything you need to know about Strucutured Data. ",
            canonical: "https://www.seoberlino.com" + req.originalUrl
        });
    }
);
...
app.get("/en/seo-services/link-building-to-brandbuilding", (req, res) => {
    ...
    res.render("blogoffpage/blogbrandbuilding", {
        ...
        description:
            "Link Bulding is now very connected to PR and how to spread visibility online. Read about how you need to adapt your PR online strategy.",
        canonical: "https://www.seoberlino.com" + req.originalUrl
    });
});
...
app.get("/en/seo-services/how-to-get-those-first-links", (req, res) => {
    ...
    res.render("blogoffpage/blogfirstlinks", {
        ...
        description:
            "Read this article about SEO and Back linking and how to get your first backlinks in a simple way: clients, sponsoring, specialised websites, etc.",
        canonical: "https://www.seoberlino.com" + req.originalUrl
    });
});
...
app.get("/en/seo-services/site-migration-seo-checklist", (req, res) => {
    ...
    res.render("blogtech/blogsitemigration", {
        ...
        description:
            "Read this article about site migration and what to do before you start migration.",
        canonical: "https://www.seoberlino.com" + req.originalUrl
    });
});
