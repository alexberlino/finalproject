    ...
    render() {
        ...
        return (
            <div className="mainHP">
                ...
                <div className="intro">
                    <div className="">
                        <p className="txt2 block">{t("intro2")}</p>
                        <p className="txt2 block">{t("intro4")}</p>
                        <p className="txt2 block">{t("intro3")}</p>
                ...
                <div className="introQuarter2">
                    <div className="footerQuarter">
                        ...
                        <span className="block">
                            keyword brainstorm from current traffic/ ppc / many
                            tools
                        </span>
                        <span className="block">
                            current main KWs rankings including competitors
                        </span>
                        <span className="block bold">2. On-page Audit</span>
                        <span className="block">
                            content for traffic, site vs optimum keyword
                            strategy
                        </span>
                        <span className="block">
                    ...
                    <div className="footerQuarter">
                        ...
                        <span className="block">indexation, crawlability</span>
                        <span className="block">
                    ...
                    <div className="footerQuarter">
                        ...
                        <p className=" italic introQuarter ">
                            documents and access needed before audit: Search
                            Console & Google Analytics, Business Overview,
                            Industry Market research including competition,
                            geographical & personas targets, Google Ads data
                        </p>
                    </div>
                    ...
                    <div className="footerQuarter">
                        ...
                        <a href="/reporttemplate.pdf">
                            <img
                                ...
                                title="audit outline example, no content (original 25 pages long) for confidentiality reasons"
                            />{" "}
                        </a>
                    </div>
                </div>
